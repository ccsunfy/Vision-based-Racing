...
class RacingEnv(DroneGymEnvsBase):
    def __init__(
        ...
        #                             "class": "Uniform",
        #                             "kwargs":
        #                                 {"position": {"mean": [2., 2., 1], "half": [.5, .5, 0.5]}},

        #                         },
        #                         {
        #                             "class": "Uniform",
        #                             "kwargs":
        #                                 {"position": {"mean": [2., -2., 1.5], "half": [.5, .5, 0.5]}},

        #                         },
        #                         {
        #                             "class": "Uniform",
        #                             "kwargs":
        #                                 {"position": {"mean": [6., 2., 1.5], "half": [.5, .5, 0.5]}},

        #                         },
        #                         {
        #                             "class": "Uniform",
        #                             "kwargs":
        #                                 {"position": {"mean": [6., -2., 1], "half": [.5, .5, 0.5]}},
                        ...
                        {"randomizers_kwargs":
                            [
                                ...
                                },
                                {
                                    "class": "Uniform",
                                    "kwargs":
                                        {"position": {"mean": [10., 2., 1.5], "half": [.2, .2, 0.2]}},
    ...
    def get_reward(self) -> th.Tensor:
        ...
        reward = r_prog1 + r_crash  + r_pass + r_cmd + r_col_avoid #+ r_v
        return reward  
