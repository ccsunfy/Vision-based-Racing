...
#     white_bg = np.ones((h, w, 4), dtype=np.float32) * 255  # RGBA全255为白色
    
#     # 初始化合成图像为白色背景
#     combined_image = white_bg.copy()
...
#         # 将masked区域合并到白色背景上
#         alpha = masked_img[..., 3:4] / 255.0
#         combined_image = combined_image * (1 - alpha) + masked_img * alpha
...
def main():
    ...
    r3 = Config(start=1, interval=10, end=118, name="examples/ete_racing_sim/cc_straight")
