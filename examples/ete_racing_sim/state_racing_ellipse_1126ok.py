...
def main():
        ...
        if args.weight is not None:
            ...
            model = ppo(
                ...
                policy_kwargs=dict(
                    ...
                    pi_features_extractor_class=extractors.ActionStateImageExtractor,
                    ...
                    vf_features_extractor_class=extractors.ActionStateImageExtractor,
    ...
    # Testing mode with a trained weight
        ...
        env = RacingEnv2(num_agent_per_scene=4, visual=True,
                            # random_kwargs=random_kwargs,
                            scene_kwargs={
                                 "path": scene_path,
                                 "render_settings": {
