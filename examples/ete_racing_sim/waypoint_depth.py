...
# scene_path = "datasets/spy_datasets/configs/demo1_straight_random_ob"
# scene_path = "datasets/spy_datasets/configs/demo1_songjiang"
# scene_path = "datasets/spy_datasets/configs/demo1_test"
...
# scene_path = "datasets/spy_datasets/configs/demo2_test"
# scene_path = "datasets/spy_datasets/configs/demo2_songjiang"
# scene_path = "datasets/spy_datasets/configs/demo2_3Dcircle_random_ob"
...
def main():
    ...
    if args.train:
        ...
        model.learn(training_params["learning_step"],
                    tb_log_name="demo3_ob_919_hitl_video",)
        # model.learn(training_params["learning_step"],
        ...
        env = RacingEnv2(num_agent_per_scene=1, visual=True,
                            ...
                            scene_kwargs={
                                 ...
                                 "render_settings": {
                                     ...
                                     "position": th.tensor([[-0.5, -6.7, 5.5], [2.5, -2.8, 3.5]]),# demo2_3Dcircle
