...
from envs.HoverEnv import HoverEnv# from envs.demo3_ellipse_onboard  import RacingEnv2
...
def main():
    ...
    if args.train:
        env = HoverEnv(num_agent_per_scene=training_params["num_env"],
        ...
        if args.weight is not None:
            ...
            model = ppo(
                ...
                policy_kwargs=dict(
                    ...
                    pi_features_extractor_class=extractors.StateExtractor,
                    ...
                    vf_features_extractor_class=extractors.StateExtractor,
        ...
        model.learn(training_params["learning_step"],
                    tb_log_name="ppo_duibi_hovering",)
        # model.learn(training_params["learning_step"],
        #             tb_log_name="waypoint_state_bodyrate_2_straight_reward")
        logging.info('Training completed')
        # 在训练部分添加
        model_name = f"ppo_duibi_hovering"  # 或其他命名方式
    ...
    # Testing mode with a trained weight
        ...
        env = HoverEnv(num_agent_per_scene=1, visual=True,
